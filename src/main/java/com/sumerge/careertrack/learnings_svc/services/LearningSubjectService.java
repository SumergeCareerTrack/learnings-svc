...
public class LearningSubjectService {
    ...
    public LearningSubjectResponseDTO createSubject(LearningSubjectRequestDTO learning) throws Exception {
        ...
        SubjectType type = learning.getType().toLowerCase().equals("functional") ? SubjectType.FUNCTIONAL
                : SubjectType.ORGANISATIONAL;
    ...
    public void deleteSubject(UUID subjectId) throws Exception {
        ...
        if (learnings.isEmpty()) {
            ...
            throw new AlreadyExistsException(AlreadyExistsException.LEARNING_HAS_SUBJECT, learnings.size(),
                    subject.getName());
        }
